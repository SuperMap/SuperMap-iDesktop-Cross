...
public class ParameterSaveDatasetPanel extends SwingPanel implements IParameterPanel {
	...
	public ParameterSaveDatasetPanel(IParameter parameterSaveDataset) {
		...
		labelDatasource = new JLabel(CoreProperties.getString("String_Label_Datasource"));
		...
		ComponentUIUtilities.setName(this.datasourceComboBox, parameter.getDescription() + "_comboBox");
		ComponentUIUtilities.setName(this.textFieldDataset, parameter.getDescription() + "_textField");
