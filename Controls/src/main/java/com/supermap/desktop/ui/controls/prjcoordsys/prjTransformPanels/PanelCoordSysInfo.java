...
public class PanelCoordSysInfo extends JPanel {
	...
	private void initLayout() {
		...
		if (this.isAddTip) {
			this.add(labelCoordInfoWithProvider, new GridBagConstraintsHelper(0, 0, 1, 1).setAnchor(GridBagConstraints.CENTER).setWeight(1, 0).setFill(GridBagConstraints.HORIZONTAL).setInsets(0, 1, 0, 0));
		} else {
			this.add(labelCoordInfo, new GridBagConstraintsHelper(0, 0, 1, 1).setAnchor(GridBagConstraints.CENTER).setWeight(1, 0).setFill(GridBagConstraints.HORIZONTAL));
		}
