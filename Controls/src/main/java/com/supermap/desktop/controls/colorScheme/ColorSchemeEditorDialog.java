...
public class ColorSchemeEditorDialog extends SmDialog {
	...
	private void initComponents() {
		...
		this.jButtonSelectAllButton.setIcon(CoreResources.getIcon("/coreresources/ToolBar/Image_ToolButton_SelectAll.png"));

		this.jButtonSelectInvert = new SmButton();
		this.jButtonSelectInvert.setIcon(CoreResources.getIcon("/coreresources/ToolBar/Image_ToolButton_SelectInverse.png"));

		this.jButtonAddColorButton = new SmButton();
		this.jButtonAddColorButton.setIcon(ControlsResources.getIcon("/controlsresources/ToolBar/ColorScheme/addColor.png"));
		...
		this.jButtonRemoveColorButton.setIcon(CoreResources.getIcon("/coreresources/ToolBar/Image_ToolButton_Delete.png"));

		this.jButtonMoveTopButton = new SmButton();
		this.jButtonMoveTopButton.setIcon(ControlsResources.getIcon("/controlsresources/ToolBar/ColorScheme/moveToTop.png"));

		this.jButtonMoveUpButton = new SmButton();
		this.jButtonMoveUpButton.setIcon(ControlsResources.getIcon("/controlsresources/ToolBar/ColorScheme/moveUp.png"));

		this.jButtonMoveDownButton = new SmButton();
		this.jButtonMoveDownButton.setIcon(ControlsResources.getIcon("/controlsresources/ToolBar/ColorScheme/moveDown.png"));

		this.jButtonMoveBottomButton = new SmButton();
		this.jButtonMoveBottomButton.setIcon(ControlsResources.getIcon("/controlsresources/ToolBar/ColorScheme/moveBottom.png"));
	...
	private void initResources() {
		...
		jButtonCancelButton.setText(CoreProperties.getString(CoreProperties.Cancel));
