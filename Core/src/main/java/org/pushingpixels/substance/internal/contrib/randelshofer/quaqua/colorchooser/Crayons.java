 ...
 * 1.1 2005-08-30 Rearranged code to ease the creation of derived look
 * and feels. <br>
...
public class Crayons extends javax.swing.JPanel {
	...
	/**
	 * Sets the current color. This results in a selection of a crayon, if a
	 * crayon with the same RGB values exists.
	 */
	...
	public void paintComponent(Graphics gr) {
		...
		if (selectedCrayon != null) {
			...
			g2d.drawString(selectedCrayon.name,
					(crayonsImage.getWidth() / scaleFactor - nameWidth) / 2, fm.getAscent() + 1);
		}
		g2d.dispose();
	}
