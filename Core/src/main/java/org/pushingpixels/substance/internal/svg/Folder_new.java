 ...
 */
public class Folder_new implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
// _0_1
	...
	public static Folder_new of(int width, int height) {
		Folder_new result = new Folder_new();
		result.width = width;
