...
// _0_1_2_4
	...
	public static Dialog_information of(int width, int height) {
		Dialog_information result = new Dialog_information();
		result.width = width;
