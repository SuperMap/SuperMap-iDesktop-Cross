 ...
 */
public class Edit_delete_2 implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
// _0_0_20
	...
	public static Edit_delete_2 of(int width, int height) {
		Edit_delete_2 result = new Edit_delete_2();
		result.width = width;
