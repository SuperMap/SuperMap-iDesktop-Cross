 ...
 */
public class autoscroll_v implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
// _0_2
	...
	public static autoscroll_v of(int width, int height) {
		autoscroll_v result = new autoscroll_v();
		result.width = width;
