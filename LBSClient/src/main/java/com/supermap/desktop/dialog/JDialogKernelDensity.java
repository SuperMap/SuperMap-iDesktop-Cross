...
//                buttonOKActionPerformed();
	...
	private void initializeComponents() {
		...
		this.comboBoxMethod.addItem(ControlsProperties.getString("String_SimpleDensity"));
		this.comboBoxMethod.addItem(ControlsProperties.getString("String_KernelDensity"));
		this.gridType = new JLabel();
		this.comboBoxType= new JComboBox();
		this.comboBoxType.addItem(ControlsProperties.getString("String_QuadrilateralMesh"));
		this.comboBoxType.addItem(ControlsProperties.getString("String_HexagonalMesh"));
...
//        this.buttonOutputBrowser = new JButton();
	...
	private void initializeResources() {
		this.labelInputURL.setText(ControlsProperties.getString("String_FileInputPath"));
		this.labelResolution.setText(CoreProperties.getString("String_Resolution"));
		this.labelRadius.setText(CoreProperties.getString("String_SearchRadius"));
		...
		this.analystMethod.setText(ControlsProperties.getString("String_AnalyseType"));
		this.gridType.setText(LBSClientProperties.getString("String_MeshType"));
		this.labelOutputURL.setText(ControlsProperties.getString("String_OutputURL"));
		...
		this.setTitle(ControlsProperties.getString("String_KernelDensity"));
