...
public class FileUtilites {
	...
	public static void IOCopy(String sourcePath, String targetPath) {
		...
		if (!file.exists()) {
			System.out.println(file.getName() + ConfigToolProperties.getString("String_FileNotExists"));
		}
	...
	public static boolean createDir(String destDirName) {
		...
		if (dir.exists()) {// 判断目录是否存在
			System.out.println(ConfigToolProperties.getString("String_CreateDirectoryFailedForIsExists"));
			return false;
		}
		...
		if (dir.mkdirs()) {// 创建目标目录
			System.out.println(ConfigToolProperties.getString("String_CreateDirectorySuccess") + destDirName);
			return true;
		} else {
			System.out.println(ConfigToolProperties.getString("String_CreateDirectoryFailed"));
			return false;
		}
	}
}
