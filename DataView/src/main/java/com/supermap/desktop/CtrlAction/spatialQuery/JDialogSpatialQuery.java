...
//		comboBoxDatasource.setEnabled(enabled && );
	...
	private void initResources() {
		...
		smButtonCancel.setText(CoreProperties.getString(CoreProperties.Close));
		...
		this.buttonInvert.setToolTipText(CoreProperties.getString(CoreProperties.selectInverse));
		this.buttonReset.setIcon(CoreResources.getIcon("/coreresources/ToolBar/Image_ToolButton_UndoSysDefault.png"));
		this.buttonReset.setToolTipText(CoreProperties.getString(CoreProperties.Reset));
	}
