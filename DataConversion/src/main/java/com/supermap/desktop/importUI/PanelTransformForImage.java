...
public class PanelTransformForImage extends PanelTransform {
	...
	private JFileChooserControl chooserControlPrjFile;
	...
	private FileChooserPathChangedListener fileChanegedListener = new FileChooserPathChangedListener() {
		@Override
		public void pathChanged() {
			// 设置坐标参考文件
			String worldFile = chooserControlPrjFile.getPath();
	...
	private void setWorldFilePath(String worldFile) {
		if (null != panelImports) {
			for (PanelImport panelImport : panelImports) {
				((PanelTransformForImage) panelImport.getTransform()).getChooserControlPrjFile().setPath(worldFile);
			}
		} else {
			if (importSetting instanceof ImportSettingBMP) {
...
//            chooserControlPrjFile.getEditor().setText(((ImportSettingBMP) importSetting).getWorldFilePath());
			chooserControlPrjFile.setPath(((ImportSettingBMP) importSetting).getWorldFilePath());
...
//            chooserControlPrjFile.getEditor().setText(((ImportSettingJPG) importSetting).getWorldFilePath());
			chooserControlPrjFile.setPath(((ImportSettingJPG) importSetting).getWorldFilePath());
...
//            chooserControlPrjFile.getEditor().setText(((ImportSettingPNG) importSetting).getWorldFilePath());
			chooserControlPrjFile.setPath(((ImportSettingPNG) importSetting).getWorldFilePath());
...
//            chooserControlPrjFile.getEditor().setText(((ImportSettingGIF) importSetting).getWorldFilePath());
			chooserControlPrjFile.setPath(((ImportSettingGIF) importSetting).getWorldFilePath());
		}
	}
...
//            this.chooserControlPrjFile.getEditor().setText(getPrjFilePath());
			this.chooserControlPrjFile.setPath(getPrjFilePath());
		}
	}
...
//        this.chooserControlPrjFile.getButton().addActionListener(this.prjFileListener);
		this.chooserControlPrjFile.addFileChangedListener(this.fileChanegedListener);
	...
	public void removeEvents() {
		...
		this.chooserControlPrjFile.removePathChangedListener(this.fileChanegedListener);
//        this.chooserControlPrjFile.getButton().removeActionListener(this.prjFileListener);
	...
	public JFileChooserControl getChooserControlPrjFile() {
