		...
		if (!SmFileChoose.isModuleExist("CommonFunction")) {
			if (SystemPropertyUtilities.isWindows()) {
				String fileFilters = SmFileChoose.buildFileFilters(
						...
						SmFileChoose.createFileFilter(FileTypeLocale.getDescriptionnew()[5], "csv", "xls", "xlsx"),
				...
				String fileFilters = SmFileChoose.buildFileFilters(
						...
						SmFileChoose.createFileFilter(FileTypeLocale.getDescriptionnewforlinux()[3], "csv", "xls", "xlsx"),
