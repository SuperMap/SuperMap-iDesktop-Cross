...
public class CanvasCursor {
	...
	private final static String ARITHMETIC_PATH = "/processresources/Cursor_Connection(bak).png";

	public final static Image IMAGE_CONNECTING = ((ImageIcon) ProcessResources.getIcon(CONNECTING_PATH)).getImage();
	public final static Image IMAGE_ARITHMETIC = ((ImageIcon) ProcessResources.getIcon(ARITHMETIC_PATH)).getImage();
	...
	public static void setArithmeticCursor(GraphCanvas canvas) {
		CursorUtilities.setCustomCursor(canvas, IMAGE_ARITHMETIC, "Cursor_Arithmetic");
	}
