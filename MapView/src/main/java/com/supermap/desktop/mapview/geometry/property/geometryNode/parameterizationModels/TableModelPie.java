 ...
 * @author XiaJT
 */
public class TableModelPie extends GeometryParameterModel {
	private GeoPie geometry;
	...
	public TableModelPie(IGeometry iGeometry) {
		geometry = (GeoPie) iGeometry.getGeometry();
	}
