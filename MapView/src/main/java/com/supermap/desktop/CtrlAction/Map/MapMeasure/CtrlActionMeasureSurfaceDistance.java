...
import com.supermap.desktop.CtrlAction.Map.MapMeasure.Measure.MeasureSurfaceDistance;
...
public class CtrlActionMeasureSurfaceDistance extends CtrlAction {
    public static HashMap<MapControl, MeasureSurfaceDistance> hashMap;
    ...
    protected void run() {
        ...
        if (activeForm instanceof FormMap) {
            ...
            MeasureUtilties.startMeasure((FormMap) activeForm, MeasureType.Distance_Surface, datasetGrid);
        }
    }
