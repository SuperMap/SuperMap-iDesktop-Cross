...
public class ThemeLabelPropertyPanel extends ThemeChangePanel {
	...
	private void initResources() {
		...
		this.labelShowSubscription.setIcon(CoreResources.getIcon("/coreresources/Image_Help.png"));
		...
		this.labelShowLabelVertical.setIcon(CoreResources.getIcon("/coreresources/Image_Help.png"));
	...
	private void initCheckboxState() {
		...
		if (datasetVector.getType() == DatasetType.POINT || datasetVector.getType() == DatasetType.POINT3D) {
			...
			this.checkBoxFlowVisual.setSelected(false);
		} else {
