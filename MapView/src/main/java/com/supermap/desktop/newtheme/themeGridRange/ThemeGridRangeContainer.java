			...
			switch (rangeMethod) {
				...
				case 3:
					...
					if (themeGridRange.getCount() > 2) {
						if (StringUtilities.isNumber(new DecimalFormat("0").format(themeGridRange.getItem(1).getEnd() - themeGridRange.getItem(1).getStart()))) {
							defaultRangeCount = Double.valueOf(new DecimalFormat("0").format(themeGridRange.getItem(1).getEnd() - themeGridRange.getItem(1).getStart()));
						}
					} else {
						if (StringUtilities.isNumber(new DecimalFormat("0").format(themeGridRange.getItem(0).getEnd()))) {
